...
// Validate ../../app/api/cron/check-deadlines/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/cron/check-deadlines">> = Specific
  const handler = {} as typeof import("../../app/api/cron/check-deadlines/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
