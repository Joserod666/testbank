...
import { TestEmailButton } from "@/components/alerts/test-email-button"
      ...
      <main className="container flex-1 px-4 py-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Gestiona tus recordatorios y notificaciones de proyectos</p>
          </div>
